...
The Hospital Emergency Room Dashboard is an interactive Power BI project designed to analyze and monitor emergency room operations using healthcare data. This dashboard provides meaningful insights into patient visits, wait times, satisfaction scores, referrals, demographics, and admission trends. The project helps hospitals improve operational efficiency, optimize staffing, and enhance patient care through data-driven decision making.

Project Objectives
Analyze emergency room patient records and operational performance.
Monitor patient wait times and satisfaction levels.
Identify peak busy hours and busiest days.
...
Admission Status Monitoring – Displays admitted and non-admitted patient distribution.
Department Referral Insights – Analyzes referrals across departments such as General Practice, Orthopedics, Cardiology, and Physiotherapy.
...
Average patient satisfaction score was 4.99/10.
